...
import 'package:todoapp/cubit/database_bloc.dart';
      ...
      body: BlocConsumer<DatabaseBloc, DatabaseState>(
        listener: (context, state) {
          if (state is LoadDatabaseState) { 
            _todoBloc = TodoCubit(database: context.read<DatabaseBloc>().database!);
          }
        },
        builder: (context, state) {
          if (state is LoadDatabaseState) {
            return BlocProvider<TodoCubit>(
              create: (context) => _todoBloc!..getTodo(),
